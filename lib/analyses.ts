...
export const ANALYSES: Record<string, string> = {
  ...
  "Funnel commercial": "Modélise concrètement le travail commercial : N leads bruts/mois (générés par budget ads) → % effectivement appelés par freelance → taux conversion appel → bilan signé → conversion bilan → abonnement. Coût total = freelance horaire (heures × taux) + bonus optionnels (par bilan ou abo) + budget ads. Remplace le 'marketing.monthlyBudget' flat du P&L par un calcul piloté par le volume de leads. Voir /funnel-bp.",
  "Lead funnel": "Voir 'Funnel commercial'. Étape amont du Bilan funnel : leads bruts → appels → bilans signés.",

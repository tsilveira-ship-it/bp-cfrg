...
export const ANALYSES: Record<string, string> = {
  ...
  "Impôts": "Impôt sur les Sociétés (IS). 25% sur le résultat positif en France. Si résultat négatif → 0 (déficit reportable).",
  ...
  "Legacy": "Anciens membres en perte progressive (-24/an).",
  ...
  "Cash Flow Investissement (CFI)": "Décaissements pour acheter le matériel. Négatif au M0 (-276k€), 0 ensuite.",
